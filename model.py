...
from silberNVIDIAutils import INPUT_SHAPE, batch_generator
import argparse
import os
...
def main():
    ...
    parser.add_argument('-d', help='data directory',        dest='data_dir',          type=str,   default='/home/carnd/car-behavior-cloning/data')
